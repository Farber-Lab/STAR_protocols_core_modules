...
mirrorPlotRACER(assoc_data1 = eqtl_b4galnt3_ld, assoc_data2 = gwas_b4galnt3_ld, chr = chr, name1 = "B4GALNT3 eQTL", name2 = "BMD GWAS", plotby = "gene", gene_plot = "B4GALNT3", label_lead = TRUE)
```
